...
export function ImportFailuresTable({
  ...
  return (
    <section className="shrink-0 rounded-lg border border-red-200 bg-red-50/40">
      <button
        type="button"
      ...
      {expanded ? (
        <div className="max-h-24 overflow-auto border-t border-red-100">
  ...
  return (
    <section className="shrink-0 space-y-2">
      <div className="rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-2">
        <h3 className="text-xs font-semibold text-emerald-900">导入完成</h3>
        <div className="mt-1 flex flex-wrap gap-x-3 gap-y-0.5 text-xs text-emerald-800">
      ...
      {result.skippedDuplicates.length > 0 ? (
        <div className="rounded-lg border border-amber-200 bg-amber-50/50">
          ...
          {duplicatesExpanded ? (
            <div className="max-h-24 overflow-auto border-t border-amber-100">
